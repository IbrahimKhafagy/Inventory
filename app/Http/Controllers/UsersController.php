...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public function create()
    {
        ...
        // dd($roles);
        return view('users.create', compact('roles','comp','inv'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($count_user < 6 || Auth::user()->companies_id == 1) {
           ...
           // $count_user->create(array_merge($request->validated(), [
           ...
           // $input['inventory_id'] = Hash::make($input['inventory_id']);
           ...
           // ]);
            //$user->$request->input('inventory_id');
            $mailData = [
    ...
    public function edit($id)
    {
       ...
       // $roles = Role::pluck('name', 'name')->all();
        ...
        return view('users.edit', compact('user', 'roles', 'userRole', 'comp','inv'));
    }
...
public function see(){
    ...
    $data = User::whereHas('roles', function ($query) {
        $query->where('name', 'Administration Chainnest');
    })->get();

    return view('advertisements.Ad_Adminstration',compact('data'));
}

public function dashboard()
{

    $Dashbord = Companies::where('Company_name', '!=', 'Chain Nest Adminstration')->get();

    $data = User::get();

    return view('advertisements.dashboard_Adminstration', compact('Dashbord', 'data'));
}
public function user()
{

    return view('advertisements.user_ dashboard');
