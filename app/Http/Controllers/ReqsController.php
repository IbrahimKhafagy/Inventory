...
class ReqsController extends Controller
{
    ...
    public function getAllReq(){
       ...
       // $Co_Req= companyreq::with(['invento'])->where('status_id','=',1)->with(['Status'])->get();
        $Co_Req= companyreq::where('status_id','=',1)->where('inventory_id','=',1)->with(['Status'])->get();
   ...
   public function addReqSubmit(Request $request){
    //   dd($request);
       // DB::table('companyreqs')->insert([
        $newCompanyReq= companyreq::with(['invento'])->where('inventory_id','=',1)->get();
        $id = $request->id;
...
////////////////////////////////////////////////////////// approve request/////////////////////////////////////////////
    ...
    {
       // $Company = companyreq::with(['invento'])->where('inventory_id','=',1)->get();
        // dd($reqs);
