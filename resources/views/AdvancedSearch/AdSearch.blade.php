            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h1 style="text-align: center">
                        <font color="#faab0c">Advanced Search</font>
                    </h1>
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" name="keyword" placeholder="Enter Product_name"
                                        type="text" value="{{ Request::get('keyword') }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="Location" placeholder="Enter Location"
                                        value="{{ Request::get('Location') }}" type="text">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="Supplier" placeholder="Enter Supplier" type="text"
                                        id="Supplier">
                                </div>
                            </div>
                            <div class="col-6">
                                <label class="my-1 mr-2" for="inlineFormCustomSelectPref">unit_name</label>
                                <select name="Unit" id="Unit" class="form-control">
                                    <option value="" selected disabled> -- Select the unit Name--
                                    </option>
                                    @foreach ($un as $un)
                                        <option value="{{ $un->id }}"
                                            {{ Request::get('unit_name') == $un->id ? 'selected' : '' }}>
                                            {{ $un->unit_name }}</option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="example" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr class="table-success" style="text-align: center">
                                ...
                                <th class="border-bottom-0">Com.Name</th>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label class="btn btn-outline-primary"><a href="{{ route('add.product') }}">Create</a></label>
                    ...
                    <a class="btn btn-danger" data-url="{{ url('inventoryDeleteAll') }}">Delete
                        Selected</a>
                    <!-- End Example Code -->
                </div>
            </div>
