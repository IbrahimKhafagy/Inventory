            ...
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-danger delete_all" data-url="{{ url('inventoryDeleteAll') }}">Delete All
                        ...
                        {{-- @endcan --}}
                        {{-- @can('product-restore') --}}
                        <a class="btn btn-warning restore" href="{{ route('products.destroy')}}"  > Trashed </a>
                                ...
                                @foreach ($products as $key => $products)
                                    ...
                                    <tr style="text-align: center" id="tr_{{ $products->id }}">
                                        ...
                                        <td>{!! DNS1D::getBarcodeHTML("$products->product_code", 'PHARMA') !!}
                                            ...
                                            <p><a href="{{ route('prnpriviewf', ['id' => $products->id]) }}" class="btn btn-success">Print</a></p>
                                        </td>
                       ...
                       {!! DNS1D::getBarcodeHTML('4445645656', 'UPCA') !!}--->
                                        ...
                                        <td>
                                            @if ($products->productype_id == 1)
                                                <a href="{{ url('send-notification', $products->id) }}" class="btn btn-secondary">
                                                    Ask For Selling
                                                </a>
                                            @else
                                                <a href="{{ url('send-notification', $products->id) }}" class="btn btn-secondary">
                                    ...
                                    @endcan
                                        ...
                                        <td>
                                            ...
                                            @can('product-delete')
                                                <a href="DeleteProduct/{{ $products->id }}" class=" show_confirm btn btn-danger"
