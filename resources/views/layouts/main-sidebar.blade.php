    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'inventory')) }}">Main Inventory<span
                                class="badge badge-danger side-badge">
                                {{ auth()->user()->unreadNotifications()->where('type', 'App\Notifications\Addproduct')->where('data->user_company', Auth::user()->companies_id)->count() }}
                                New</span></a></li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Sec_Invntories')) }}">All
                            Sub-Inventories</a></li>
...
@can('Advertisment')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                        </svg><span class="side-menu__label">Advertisments</span><i class="angle fe fe-chevron-down">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="/Advertisements.create">new ad.</a></li>
                        <li><a class="slide-item" href="/Advertisements_show">all Ads.</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'logs')) }}">logs</a></li>
                ...
                <ul class="slide-menu">
                    ...
                    @endcan
                    @can('outedit-user')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'users.edit1')) }}">Edit your profile</a>
                        </li>
                    @endcan
                    ...
                    @can('Edit-companylogo')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'companyEditlogo')) }}">Edit company</a>
                        </li>
                    @endcan
                    @can('permission_list')
