        ...
        <div class="main-header-left ">
            ...
            <div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
                <form type="get" action="{{ route('search.product') }}">
                    ...
                    <input class="form-control" placeholder="Search for products.." type="search" name="query"> <a
                        class="btn" href="https://www.chainnest.net/search" method="get" type="submit"><i
                            class="fas fa-search d-none d-md-block"></i></a>
                </form>
            </div>
            <a href="{{ route('AdSearch.AD') }}"> Advanced Search</a>

            {{-- <a href="{{ route('AD') }}"> Advanced Search1</a>- --}}

        </div>

        <div class="main-header-right">
            <ul class="nav">
                <a href="{{ route('convert.curr') }}"> Convert Currency</a>
            </ul>
        </div>
       {{-----}} <div class="main-header-right">
            <ul class="nav">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-left">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-center"><a
                                            href="\MarkAsRead_all">Mark All Read</a></span>
                                            <span class="badge badge-pill badge-warning mr-auto my-auto float-center">

                                                <a href="notifications">see all</a></span>
                                </div>
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                <h5 style="color:aliceblue" id="notifications_count">
                            ...
                            <div id="unreadNotifications">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        ...
                                        <span class="badge badge-pill badge-warning mr-auto my-auto float-center"><a
                                            href="{{ route('DeleteNoti', ['id' => $notification->id]) }}">Undo</a></span>
                                        <a class="d-flex p-3 border-bottom" href="{{ url('product-user') }}/{{isset($notification->data['id']) ? $notification->data['id'] : ''  }}/user/{{isset($notification->data['user_id']) ? $notification->data['user_id'] : ''  }}">
                                            ...
                                            <div class="mr-3">
                                                <h5 class="notification-label mb-1">{{ $notification->data['title'] }}
                                                    {{isset($notification->data['user']) ? $notification->data['user'] : '' }}
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="Company_Logo/{{ Auth::user(0)->Compan->Company_Logo }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="Company_Logo/{{ Auth::user(0)->Compan->Company_Logo }}" class="">
                                </div>
                                <div class="mr-3 my-auto">
                                    <h6>{{ Auth::user(0)->name }}</h6><span>{{ Auth::user(0)->email }}</span><span>
                                        {{ Auth::user(0)->getRoleNames()[0] }}</span>
                                </div>
                            </div>
                        </div>
                       <!-- <a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</a>-->
                        <a class="dropdown-item" href="{{ route('edit1.users') }}"><i class="bx bx-cog"></i> Edit
                            Profile</a>
