...
Route::get('Ad_Adminstration', [App\Http\Controllers\UsersController::class, 'see'])->name('advertisements');
Route::get('dashboard_Adminstration', [App\Http\Controllers\UsersController::class, 'dashboard'])->name('dashboard_Adminstration');
Route::get('user_ dashboard', [App\Http\Controllers\UsersController::class, 'user'])->name('user_ dashboard');
Route::get('logs', [App\Http\Controllers\UsersController::class, 'logs'])->name('user_logs');

Route::get('Advertisements.create', [App\Http\Controllers\AdvertisementsController::class, 'index']);
...
Route::get('DeleteProduct/{id}', [App\Http\Controllers\ProductsController::class, 'delete'])->name('delete.pro');
...
Route::get('products/trash', [App\Http\Controllers\ProductsController::class, 'trash'])->name('products.destroy');

Route::get('products/restore/{id}', [ProductsController::class, 'restoreone'])->name('products.restore-one');

Route::get('products/', [App\Http\Controllers\ProductsController::class, 'restore'])->name('products.restore');
...
Route::post('To_inv_select/{id}', [App\Http\Controllers\TransactionController::class, 'To_inv_select'])->name('To_inv_select');
// Route::post('confirm-trans/{id}', [App\Http\Controllers\TransactionController::class, 'confirm'])->name('confirm-trans');
